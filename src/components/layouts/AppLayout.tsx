  ...
  return (
    <div className="w-full h-full bg-gray-900">
      <div>
        ...
        <div className="hidden xl:fixed xl:inset-y-0 xl:z-50 xl:flex xl:w-72 xl:flex-col bg-gray-800 border-r border-r-gray-700">
          {/* Sidebar component, swap this element with another sidebar if you like */}
        ...
        <div className="xl:pl-72">
          <div className="xl:hidden border-b border-b-gray-700  bg-gray-900 h-16 p-4">
